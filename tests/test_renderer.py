...
from citta_console.renderer import render_dashboard, render_dashboard_html
...
def test_render_dashboard_html_contains_core_sections() -> None:
    html = render_dashboard_html(_report())
...
def test_render_dashboard_writes_file(tmp_path: Path) -> None:
    output = render_dashboard(_report(), tmp_path / "dashboard.html")
